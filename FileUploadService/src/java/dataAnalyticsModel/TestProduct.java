...
public class TestProduct {
     ...
     * @param pass_fail last test conclusion
     * @param systems_repeats summary of all systems and repeats
     * @param tests all tests brief information
     */
     ...
     * Set last test date
     *
     * @param last_test_date last test date MMddyyhhmmss
     */
     ...
     *
     * @param tests a list of all test brief object
     */
     ...
     *
     * @param testBrief new test brief object
     */
     ...
     *
     * @param systems_repeats new test systems and repeats information
     */

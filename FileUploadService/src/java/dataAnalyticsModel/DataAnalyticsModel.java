...
/**
 * This class is used to test the model. Test data are txVrefHigh and
 * txVrefLow.
 *
            ...
            for (int i = 0; i < 5; i++) {
                ...
                for (int j = 0; j < 5; j++) {
                    ...
                    if ((line1 = br1.readLine()) != null
                        ...
                        for (int k = 0; k < 64; k++) {
                            // construct lanes
                            lanes1[0][0][k] = new TestLane(Integer.parseInt(numbers1[k]), TestLane.VALID, "channel0", "rank0", "lane" + k);
                            lanes2[0][0][k] = new TestLane(Integer.parseInt(numbers2[k]), TestLane.VALID, "channel0", "rank0", "lane" + k);
                        }
                    }
                    // construct margins

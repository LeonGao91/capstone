...
public class EyeChart {
     ...
     * @param min an double array of min margins
     * @param mean an double array of mean min margins
     * @param intel_min an double array of Intel benchmark min margins
     * @param intel_mean an double array of Intel benchmark mean min margins
     */

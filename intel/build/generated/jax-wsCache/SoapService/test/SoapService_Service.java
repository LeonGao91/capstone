 ...
 * 
 */
@WebServiceClient(name = "SoapService", targetNamespace = "http://test/", wsdlLocation = "http://localhost:8080/SoapWebService/SoapService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICE_QNAME = new QName("http://test/", "SoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapWebService/SoapService?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://test/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test/", "SoapServicePort"), SoapService.class, features);
    }

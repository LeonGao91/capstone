<%-- 
    Document   : result1
    Created on : Apr 22, 2015, 10:19:57 AM
    Author     : Junying
--%>
...
<html lang="en">
    ...
    <body>
                ...
                <div class="container">
                    <div id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="#">Result1</a></li>
                        </ul>
        ...
        <div class="panel panel-primary main_panel">
            <div class="panel-heading">
                <h3 id="chart_header" class="panel-title" align="center">Eye Chart</h3>
            </div>
        ...
        <div class="panel panel-primary main_panel">
            <div class="panel-heading">
                <h3 id="chart_header" class="panel-title" align="center">Health/Trust Chart</h3>
            </div>
         ...
         <div class="panel panel-primary main_panel">
            <div class="panel-heading">
                <h3 id="chart_header" class="panel-title" align="center">Combination Chart</h3>
            </div>
            <div id="combination"><img src="media/combination2.png" id="combinationpng"/></div>
         </div>
